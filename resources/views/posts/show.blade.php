            ...
            <section class="col-span-8 col-start-5 mt-10 space-y-6">
                <x-panel>
                    <form action="" method="post">
                        ...
                        <div class="mt-6">
                            <textarea name="body" id="" cols="30" rows="5" class="w-full text-sm focus:outline-none focus:ring" placeholder="make a cool contribution"></textarea>
                        </div>

                        <div class="flex justify-end mt-6 border-t border-gray-200 pt-6 ">
                            <button type="submit" class="bg-blue-400 text-white uppercase rounded-2xl hover:bg-blue-600 py-2 px-10 text-xs">Post</button>
                        </div>
